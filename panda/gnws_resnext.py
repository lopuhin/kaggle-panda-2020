"""
https://github.com/joe-siyuan-qiao/pytorch-classification/blob/e6355f829e85ac05a71b8889f4fff77b9ab95d0b/models/imagenet/resnext.py
"""
import math

import torch.nn as nn

from .gnws_resnet import Conv2d, GroupNorm2d
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, baseWidth, cardinality, stride=1, downsample=None):
        ...
        self.conv1 = Conv2d(inplanes, D*C, kernel_size=1, stride=1, padding=0, bias=False)
        self.bn1 = GroupNorm2d(D*C)
        self.conv2 = Conv2d(D*C, D*C, kernel_size=3, stride=stride, padding=1, groups=C, bias=False)
        self.bn2 = GroupNorm2d(D*C)
        self.conv3 = Conv2d(D*C, planes * 4, kernel_size=1, stride=1, padding=0, bias=False)
        self.bn3 = GroupNorm2d(planes * 4)
...
class ResNeXt(nn.Module):
    ...
    def __init__(self, baseWidth, cardinality, layers, num_classes):
        ...
        for m in self.modules():
            ...
            elif isinstance(m, nn.GroupNorm):  # edited compared to source
